...
class FollowupResultScreen extends StatefulWidget {
  ...
  const FollowupResultScreen({super.key, required this.woundId});

  @override
  _FollowupResultScreenState createState() => _FollowupResultScreenState();
}

class _FollowupResultScreenState extends State<FollowupResultScreen> {
          ...
          onPressed: () {
            diagnosis.then((data) {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => WoundProgress(woundId: widget.woundId),
                ),
              );
            });
          },
